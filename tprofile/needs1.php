...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    // Update the 'need5' field in the database
...
<div class="main-content">
    ...
    <div class="container1" style="padding:32px 2rem;">
        <body>
            ...
            <form method="post" id="tagform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                <div class="tag-buttons" id="createtagdiv">
                ...
                <div style="top: -55px;position: relative;">
                    <p>Total No of Rows: <?php echo max(0, $numInputTags - 1); ?></p>
                    <div class="columns">

                    <?php
                    for ($i = 2; $i <= $numInputTags; $i++) {
                        $value = isset($existingData[$i - 1]) ? htmlspecialchars($existingData[$i - 1]) : '';
                        echo '<div class="column"><input type="text" name="input_' . $i . '" placeholder="Input ' . $i . '" value="' . $value . '" style="border: groove;width: 100%;height: 35px;border-color: black;margin-bottom: 8px;"><br></div>';
                    }
                    ?>
                    </div>
