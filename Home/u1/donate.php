...
body{
  ...
  min-height: 100vh;
  background: linear-gradient(-135deg, #9890ef, #4158d0);
}
.wrapper{
  width: 450px;
  background: #fff;
  ...
  text-decoration: none;
   ...
   <body>
      ...
      <div class="wrapper">
         ...
         <br>
         <button class="button-29" type="submit" role="button">
         <a href="javascript:void(0)" class="btn btn-sm btn-primary float-right buy_now" data-img="//www.tutsmake.com/wp-content/uploads/2019/03/c05917807.png" data-amount="10000"  data-id="<?php echo $_SESSION['trustid']; ?>">Submit</a>
         </button>
      </div> 
      </div>
      </form>
