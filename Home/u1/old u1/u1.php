    ...
    if ($result->num_rows > 0) {
        ...
        <div class="overlap-wrapper">
            <div class="overlap">
                ...
                <img class="group" src="../../trust/tsignup/upload/' . $row['pic'] . '" alt="Trust Image">

                zz
                <div class="rectangle-2"></div>
                <div class="rectangle-3"></div>
                
                <div class="overlap-group" style="top: 758px;left: 506px;">
                <div class="text-wrapper-2"><a href="donate.php" style="color: white;">Donate</a></div>
            </div>
                <a href="../../form/latest.php?trustid=' . $row['trustid'] . '">
                <div class="div-wrapper">
                <div class="overlap-group" style="top: -198px; left: 193px;"><div class="text-wrapper-3">adopt</div></div>
                </div>
                </a>
            </div>
