...
<head>
    ...
    <style>
        ...
        .comments {
            ...
            background-color: #f2f2f2; /* Background color for comments */
            padding: 20px; /* Add some padding for better readability */
            margin-top: 20px; /* Add space between Feedback and Comments */
        }
    </style>
</head>
<body>
...
<div class="main-content">
    ...
    <header>
        ...
        if (isset($_GET['trustid'])) {
            $trustid = mysqli_real_escape_string($conn, $_GET['trustid']);
        } elseif (isset($_SESSION['trustid'])) {
            $trustid = mysqli_real_escape_string($conn, $_SESSION['trustid']);
        } else {
            echo "Trust ID not found.";
            exit();
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $insertQuery = "INSERT INTO review (type, userid, rating1, rating2, commentText, trustid) VALUES (' ', '$userid', '$rating1', '$rating2', '$commentText', '$trustid')";
        ...
        // Retrieve comments for the given trustid
        $commentsQuery = "SELECT userinfo.username, review.commentText
                          FROM review
                          JOIN userinfo ON review.userid = userinfo.userid
                          WHERE review.trustid = '$trustid'";
                ...
                <div class="rt-container">
                    <div class="col-rt-12">
                        <div class="Scriptcontent">
                            ...
                            <div class="feedback" style="left: 170px;">
                            ...
                            <div class="comments" style="left: 65%;top: -431px;position: relative;">
                            <h2>Comments from Other Users</h2>
                                <table width="100%" style="margin-top: 20px;">
                                    <thead>
                                        <tr>
                                            <th>User</th>
                                            <th style="padding: 1rem 1rem;">Comment</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        while ($commentRow = mysqli_fetch_assoc($commentsResult)) {
                                            echo '<tr>
                                                    <td>' . $commentRow['username'] . '</td>
                                                    <td style="left: 21px;position: relative;">' . $commentRow['commentText'] . '</td>
                                                </tr>';
                                        }
                                        ?>
                                    </tbody>
